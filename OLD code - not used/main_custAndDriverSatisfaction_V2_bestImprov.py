...
def two_opt_improvement(
    ...
    """
    Improves a route using 2-opt local search algorithm with best improvement strategy,
    ...
    while improvement_found and iteration < max_iterations:
        ...
        # Track the best improvement in this iteration
        best_iteration_cost = best_cost
        best_iteration_route = None
        best_iteration_arrival_times = None
        best_iteration_customer_satisfaction = best_customer_satisfaction
        best_iteration_driver_satisfaction = best_driver_satisfaction
        ...
        for i in range(1, len(best_route) - 2):
            for j in range(i + 1, len(best_route) - 1):
                ...
                # If the new route is better, track it as the best in this iteration
                if new_cost < best_iteration_cost:
                    best_iteration_cost = new_cost
                    best_iteration_route = new_route
                    best_iteration_arrival_times = new_arrival_times
                    best_iteration_customer_satisfaction = new_customer_satisfaction
                    best_iteration_driver_satisfaction = new_driver_satisfaction
                    improvement_found = True

        # Apply the best improvement found in this iteration (if any)
        if improvement_found:
            best_route = best_iteration_route
            best_cost = best_iteration_cost
            arrival_times = best_iteration_arrival_times
            best_customer_satisfaction = best_iteration_customer_satisfaction
            best_driver_satisfaction = best_iteration_driver_satisfaction
