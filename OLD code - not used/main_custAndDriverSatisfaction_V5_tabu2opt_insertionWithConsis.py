    ...
    while unrouted:
        ...
        for customer in unrouted:
            ...
            for i in range(1, len(route)):
                ...
                # Apply the bonus to driver satisfaction (capped at 1.0)
                modified_driver_satisfaction = min(driver_satisfaction + edge_bonus, 1.0)

                # Calculate insertion cost (objective function value)
                insertion_cost = (1.0 - customer_satisfaction) * w_cust + (
                            1.0 - modified_driver_satisfaction) * w_driver
